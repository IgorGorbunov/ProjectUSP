...
/// <summary>
///  ласс c методами типа Select
/// </summary>
partial class SQLOracle
{

    /// <summary>
    /// ћетод, реализующий параметризированный select-запрос
    /// </summary>
    ...
    /// <summary>
    /// ћетод параметризированного запроса на получение листа данных
    /// </summary>
    /// <param name="id">ѕоле</param>
    /// <param name="table">“аблица</param>
    /// <param name="parametr">ѕараметр</param>
    /// <param name="value">«начение параметра</param>
    /// <returns>ƒанные в виде List</returns>
    ...
    /// <summary>
    /// ћетод возвращающий string значение через праметризированный селект с единичным услови€ем Where
    /// </summary>
    /// <param name="cmdQuery">select-запрос</param>
    /// <param name="Parameters">Ќазвание параметра</param>
    /// <param name="DataFromTextBox">«начение параметра</param>
    /// <returns></returns>
    static public string ParamQuerySelect(string cmdQuery, string Parameters, string DataFromTextBox)
    {
        ...
        try
        {
            ...
            if (reader.Read())
                ...
                catch (InvalidOperationException) { } //ловим нулевое значение пол€
    ...
    /// <summary>
    /// ћетод возвращающий DataSet по заданному параметризированному select-запросу 
    /// </summary>
    /// <param name="cmdQuery">строка запроса</param>
    /// <param name="Parameters">»м€ параметра</param>
    /// <param name="DataFromTextBox">«начение параметра</param>    
    ...
    /// <summary>
    /// ћетод возвращающий DataSet по заданному select-запросу
    /// </summary>
    /// <param name="cmdQuery">select-запрос</param>
    /// <returns></returns>
